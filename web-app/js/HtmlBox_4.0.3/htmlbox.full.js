...
$.fn.htmlbox=function(options){
	...
	var d={
		...
		idir:"/Publiek.cc/images/htmlbox",// HtmlBox Image Directory, This is needed for the images to work
	...
	this._init = function(is_init){
		...
		var w=$(this).css("width");var h=$(this).css("height");$(this).wrap("<table id='"+d.id+"_wrap' width='"+w+"' style='width:"+w+";height:"+h+";border:2px solid #E9EAEF;' cellspacing='0' cellpadding='0'><tr><td id='"+d.id+"_container'></td></tr></table>");
