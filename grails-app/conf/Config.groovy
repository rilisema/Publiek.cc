...
grails.mail.host = "mail.informatieraadgevers.nl"
grails.mail.port = "25"
grails.mail.username = "richard@informatieraadgevers.nl"
grails.mail.password = "rmp001"
grails.mail.props = [
			"mail.smtp.auth": "true",
...
grails.mail.default.from = "noreply@informatieraadgevers.nl"

//zaaksysteemverwijzing
...
environments {
	production {
		...
		log4j = {			
			...
			appenders {
				rollingFile name:"file", maxFileSize:102400, file:"/var/log/webapps/kcc.log"
			}
			root {
				error 'file'
				additivity = true
	...
	devMintlab {
		...
		zaaksysteem.css.url = "http://dev.zaaksysteem.nl:3002/"
	...
	prodMintlab {
		grails.serverURL = "http://localhost:8080/${appName}"
		zaaksysteem.url = "https://bussum.zaaksysteem.nl/"
		zaaksysteem.css.url = "http://bussum.zaaksysteem.nl/"
...
grails.plugins.springsecurity.requestMap.className = 'auth.Requestmap'
...
activiti {
	...
	mailServerHost = "mail.informatieraadgevers.nl"
	mailServerPort = "25"
	mailServerUsername = "richard@informatieraadgevers.nl"
	mailServerPassword = "rmp001"
	mailServerDefaultFrom = "noreply@memio.nl"
	history = "audit" // "none", "activity", "audit" or "full"
