                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="id"><g:message code="role.id.label" default="Id" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'id', 'errors')}">
                                    <g:textField name="id" value="${roleInstance?.id}" />
                                </td>
                            </tr>                           
                            <tr class="prop">
                                <td valign="top" class="name">
